...
export function usageReportingSignature(ast, operationName) {
    return printWithReducedWhitespace(sortAST(removeAliases(stripSensitiveLiterals(dropUnusedDefinitions(ast, operationName), {
