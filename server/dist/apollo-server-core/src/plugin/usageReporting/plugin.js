...
import { createOperationDerivedDataCache, operationDerivedDataCacheKey, } from './operationDerivedDataCache';
...
export function ApolloServerPluginUsageReporting(options = Object.create(null)) {
    ...
    return {
        ...
        async serverWillStart({ logger: serverLogger, apollo, serverlessFramework, }) {
            ...
            const sendReportsImmediately = options.sendReportsImmediately ?? serverlessFramework;
            ...
            const includeTracesContributingToStats = options.internal_includeTracesContributingToStats ?? false;
            let stopped = false;
                    ...
                    async willSendResponse(requestContext) {
                        ...
                        if (policyIfCacheable) {
                            treeBuilder.trace.cachePolicy = new Trace.CachePolicy({
                                scope: policyIfCacheable.scope === CacheScope.Private
